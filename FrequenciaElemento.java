...
/*
 * Esse código possui uma complexidade linear, pois no pior caso ele será executado
...
class FrequenciaElemento {
    public static void main(String[] args) {
        ...
        // Verificação do numero a ser procurado na sequencia de inteiros disponibilizada.
